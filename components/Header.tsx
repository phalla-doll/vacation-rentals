...
export function Header() {
  return (
    <header className="border-b border-neutral-200 py-4 px-6 md:px-10 xl:px-20 flex items-center justify-between w-full bg-white sticky top-0 z-50">
      ...
      {/* Search Bar */}
      <div className="hidden md:flex items-center border border-neutral-200 rounded-full shadow-sm hover:shadow-md transition-shadow duration-200 pl-2 pr-1.5 py-1.5 gap-1 text-[14px] w-auto shrink-0 cursor-pointer">
