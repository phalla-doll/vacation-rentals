...
export function Categories() {
  return (
    <div className="px-6 md:px-10 xl:px-20 pt-6 pb-4 flex items-center justify-between gap-6 bg-white border-b border-neutral-200 shadow-sm">
      ...
      <div className="flex items-center gap-4 pl-4 bg-white">
        ...
        <button className="hidden md:flex items-center gap-2 border border-neutral-200 rounded-xl px-4 py-3 text-[14px] font-medium hover:bg-neutral-50 hover:border-neutral-900 transition-all shrink-0 shadow-sm text-neutral-900">
